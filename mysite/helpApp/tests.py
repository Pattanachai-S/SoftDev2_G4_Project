...
class Check_overlap_test(TestCase):
    ...
    s4 = ["010123118", "S.1"] # 010123118 COMPUTER NETWORKS3(3-0)                S.1 W 13:00
    s5 = ["010123120", "L.1"] # 010123120 EMBEDDED SYSTEM DESIGN LABOR1(0-1)     L.1 W 13:00
    s6 = ["010123121", "S.1"] # 010123121 DATABASE SYSTEMS3(3-0)                 S.1 F 9:00
    s7 = ["010123134", "S.1"] # 010123134 COMPUTER ORGANIZATION3(3-0)            S.1 M 9:00
    s8 = ["010123135", "S.1"] # 010123135 LINEAR ALGEBRA3(3-0)                   S.1 M 9:00

    e1 = ["010123135", "S.1"] # 010123213 ARTIFICIAL INTELLIGENCE 3(3-0)         อ. 4/4/2566 9:00-12:00  S.1 T 9:00-12:00
    e2 = ["010123135", "S.1"] # 040203100 GENERAL MATHEMATICS 3(3-0)             อ. 4/4/2566 9:00-12:00  S.1 M 13:00
    ...
    def test_subject_time_overlap(self):
        self.assertTrue(self.o.is_subject_overlap(self.s4, self.s6))
        self.assertTrue(self.o.is_subject_overlap(self.s7, self.s8))
